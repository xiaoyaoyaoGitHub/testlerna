import { BREADCRUMBTYPES, ERRORTYPES } from '@gymito/monitor-shared'
import { breadcrumb, handleConsole, httpTransform, transportData, options as sdkOptions } from '@gymito/monitor-core'
import { ReportDataType, Replace, MITOHttp } from '@gymito/monitor-types'
import {
  extractErrorStack,
  getCurrentRoute,
  getTimestamp,
